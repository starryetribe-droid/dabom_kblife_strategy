      ...
      <div className="max-w-[1640px] mx-auto px-10 w-full h-full flex flex-col justify-start pt-2 pb-2 relative z-10">
        ...
        <div className="flex flex-col gap-4 flex-1 min-h-0">
          ...
          <FadeIn delay={200} className="w-full">
            <GlassCard className="p-0 bg-[#F3F5F7] border border-gray-200 flex flex-col">
              <div className="flex items-center justify-start gap-6 border-b border-gray-200 h-14 px-6 shrink-0">
                <h3 className="font-bold text-[#1d1d1f] text-[15px] uppercase tracking-tighter shrink-0">두뇌 건강 운동 프로그램 6종</h3>
              </div>

              {/* Grid of Games — single row (6 cols), perfectly centered vertically with equal padding */}
                ...
                <div className="grid grid-cols-6 gap-6 w-full">
                  {[
                    ...
                    <div key={idx} className="flex flex-col items-center gap-2">
                      <span className="text-[11px] text-kb-black bg-white border border-kb-yellow/60 px-2.5 py-0.5 rounded-full shadow-xs whitespace-nowrap font-black tracking-tighter inline-flex items-center justify-center h-5 leading-none">{item.label}</span>
          ...
          <FadeIn delay={300} className="w-full flex-1">
            <div className="bg-[#FAFAFA] border border-gray-100 rounded-[32px] p-5 h-full flex flex-col shadow-inner">
              ...
              <div className="flex justify-center gap-4 mb-4">
                {/* Box 1: UI/UX */}
                <div className="bg-white border-2 border-kb-yellow px-6 py-2 rounded-full shadow-sm flex items-center gap-3">
                  <div className="w-5 h-5 rounded-full bg-kb-yellow text-white flex items-center justify-center shrink-0 text-[10px]">
                    <i className="fa-solid fa-check"></i>
                  </div>
                  <span className="text-kb-black font-black text-[15px] tracking-tight">
                    진행 방법 학습부터 두뇌 운동까지 스스로, <span className="text-kb-yellow">시니어 최적화 UI/UX</span>
                  </span>
                </div>

                {/* Box 2: Auto Adjustment */}
                <div className="bg-white border-2 border-yellow-400 px-6 py-2 rounded-full shadow-sm flex items-center gap-3">
                  <div className="w-5 h-5 rounded-full bg-yellow-400 text-white flex items-center justify-center shrink-0 text-[10px]">
                    <i className="fa-solid fa-sliders"></i>
                  </div>
                  <span className="text-kb-black font-black text-[15px] tracking-tight">
                    결과 데이터 기반 <span className="text-kb-yellow font-black">난이도 자동 조정</span> 시스템 적용
                  </span>
                </div>
              </div>
              ...
              <div className="flex items-start justify-center gap-10 flex-1 py-1">
                ...
                <PhoneFrame
                  ...
                  bgColor="bg-amber-50"
                  stepLabel="Step 1. 개요 및 운동 효과 안내"
                ...
                {/* Arrow with Step 3 Shared Label */}
                <div className="flex flex-col items-center gap-3">
                  <span className="text-[15px] font-black text-kb-black text-center whitespace-nowrap">Step 3. 프로그램 Play</span>
                  <div className="flex flex-col items-center mt-25 px-2">
                    <i className="fa-solid fa-arrow-right text-kb-yellow text-[26px] drop-shadow-sm"></i>
                  </div>
                </div>
